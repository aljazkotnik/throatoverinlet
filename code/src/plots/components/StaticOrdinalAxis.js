...
export default class StaticOrdinalAxis{
	...
	draw(){
		...
		let d3axisType = obj.axis == "y" ? d3.axisLeft : d3.axisBottom;
		let d3axis = d3axisType( obj.scale );
		if(obj.ticks){ d3axis.tickValues( obj.ticks ); };
